    ...
    <div class="card-carousel-wrapper carousel-web">
      ...
      <div class="card-carousel">
        <div class="card-carousel--overflow-container">
          ...
          >
            <div
              class="card-carousel-card col-4"
              v-for="(challenge, index) in mainPageList"
              :key="index"
              @click="ChallengeMoreInfo(challenge.challenge_id)"
            >
              <challenge-list-card :challenge="challenge"></challenge-list-card>
      ...
      items: [
        {
          challenge_id: 0,
          challenge_title: '',
          challenge_contents: null,
          challenge_img: '',
          challenge_certify_contents: null,
          good_img: null,
          bad_img: null,
          day_certify_count: 0,
          only_cam: 0,
    ...
    atEndOfList() {
      return (
        ...
        this.paginationFactor *
          -1 *
          (this.mainPageList.length - this.windowSize)
      );
    },
    atHeadOfList() {
